"""
Django settings for djtableros project.
...
SECRET_KEY = "django-insecure-z!(qqo+mpda9i-=@g9c%un(6+gpz)g3bhalr$x_xj!n!-p@v#d"
...
WSGI_APPLICATION = "djtableros.wsgi.application"
